...
WEEKLY_NOTE_ROLLOVER_ROUTINE = Routine(
    ...
    agent_id="autoreiv",
    prompt="Perform the weekly rollover: create the new week's note from the template in 02_Resources/_Templates/weekly_notes.md, interpolate Monday through Sunday dates, and carry over any uncompleted tasks from the previous week's note into the Carry-Over section.",
