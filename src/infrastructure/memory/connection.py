...
class SQLiteConnectionManager:
    ...
    def _migrate_if_missing(self, conn: sqlite3.Connection) -> None:
        ...
        for table, col, decl in (
            ...
            ("agent_overrides", "storage_enabled", "INTEGER DEFAULT 0"),
            ("agent_overrides", "storage_type", "TEXT DEFAULT 'sqlite'"),
            ...
            ("custom_agents", "visibility", "TEXT DEFAULT 'public'"),
            ("custom_agents", "fleet", "TEXT"),
            ("custom_agents", "storage_enabled", "INTEGER DEFAULT 0"),
            ("custom_agents", "storage_type", "TEXT DEFAULT 'sqlite'"),
