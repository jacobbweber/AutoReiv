"""
Weekly Notes & Markdown To-Dos Skill [REQ-WNOTE-001, REQ-WNOTE-002, REQ-WNOTE-003].
...
class WeeklyNotesSkill:
    """Skill exposing Obsidian-compatible Weekly Notes and Markdown To-Dos tools."""

    def __init__(self, wiki_skill: WikiSkill, wiki_root: str = "data/wiki"):
        self.wiki_skill = wiki_skill
