"""
System Agent Skill for Platform Health, Root-Cause Diagnostics & Telemetry Inspection [REQ-AGENTS-006, REQ-AGENTS-007].
"""
...
class SystemAgentSkill:
    """
    Skill providing deep system health inspection, error root-cause diagnostics,
