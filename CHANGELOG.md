...
- Chat Input Bubble Render Fix and Vanilla Wiki Seeding Restoration (`src/web/static/modules/studios/chat/render.js`, `src/web/static/modules/studios/chat.js`, `src/application/skills/weekly_notes_tools.py`, `src/domain/wiki/store.py`, `src/domain/routines/manifests.py`, `src/application/routines/matcher.py`, `src/application/routines/scheduler.py`, `src/web/app.py`, `src/cli/main.py`, `tests/unit/frontend/chat_user_input_bubble_render_406.test.js`, `tests/unit/skills/test_weekly_notes_tools.py`, `tests/unit/wiki/test_wiki_store.py`, `tests/unit/wiki/test_vanilla_wiki_seeding.py`, `tests/unit/routines/test_schedule_matcher.py` [CARD-406]):
