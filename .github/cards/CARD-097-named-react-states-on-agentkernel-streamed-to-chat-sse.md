...
- [ ] `[REQ-KERNEL-001]`: State is exactly one of THINKING|CALLING_TOOLS|PARKED|DONE|FAILED and is persisted on the phase. No second runtime.
- [ ] `[REQ-KERNEL-002]`: Chat SSE emits job_id, phase_id, assigned_agent_id, react_state on each change.
