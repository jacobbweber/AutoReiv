...
> **Status**: Ready (inventory in progress; build after Architect Done bars + Jacob go)
> **Created**: 2026-09-13
...
- [ ] **[REQ-HYG-294-001]**: Inventory map published (classification table).
- [ ] **[REQ-HYG-294-002]**: Platform packs in repo = Assistant, AutoReiv, Coding only; homelab* not shipped as platform seeds (relocated to user data or removed from repo seed set).
- [ ] **[REQ-HYG-294-003]**: Tracked scratch removed or gitignored (`notes/` marathon/homelab, experimental `skills/`, leftover checkout `packs/` if not product).
- [ ] **[REQ-HYG-294-004]**: Single pack loader rule documented + enforced (platform from install/repo; user from `AUTOREIV_DATA_DIR`).
- [ ] **[REQ-HYG-294-005]**: Live smoke: `restart_serve` on branch; Chat/Forge pack list still loads; AppData data intact.
- [ ] **[REQ-HYG-294-006]**: CHANGELOG `[Unreleased]` notes hygiene; no wipe of user AppData.
