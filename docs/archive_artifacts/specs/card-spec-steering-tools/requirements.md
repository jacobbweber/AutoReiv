...
- REQ-SDLC-012: Tools operate on `{project_root}/docs/cards/CARD-NNN-*.md` and `{project_root}/docs/specs/<slug>/`. `project_root` is an optional argument defaulting to the AutoReiv checkout.
