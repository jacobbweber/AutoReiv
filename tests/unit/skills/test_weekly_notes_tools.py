"""
Unit tests for WeeklyNotesTools and Markdown Task Carry-Over Engine [REQ-WNOTE-001, REQ-WNOTE-002, REQ-WNOTE-003].
"""
...
def skill(temp_wiki_root):
    ...
    return WeeklyNotesTools(wiki_tools=wiki_tools, wiki_root=str(temp_wiki_root))
